                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="name" type="text" class="form-control" placeholder="e.g. Speed"
                                            name="nama" value="{{ $criteriaweight->nama }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="type">Type :</label>
                                    <select class="form-control" id="type" name="jenis">
                                        @if ($criteriaweight->jenis == "benefit")
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="weight" type="text" class="form-control" placeholder="e.g. 2.5"
                                            name="bobot" value="{{ $criteriaweight->bobot }}" required>
                                    </div>
                                </div>
                                {{-- <div class="form-group">
