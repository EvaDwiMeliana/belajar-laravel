...
class CriteriaRatingController extends Controller
{
    ...
    {
        $criteriaratings = CriteriaRating::leftJoin('criteriaweights', 'criteriarating.criteria_id', '=', 'criteriaweights.id')
        ->select(
            'criteriarating.id as id',
            'criteriarating.criteria_id as cid',
            'criteriarating.rating as rating',
            'criteriarating.description as description',
